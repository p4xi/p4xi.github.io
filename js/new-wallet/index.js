...
const defaultIndex = DOM.phraseNetwork.prop("selectedIndex");
if (networks[defaultIndex] && networks[defaultIndex].onSelect) {
    networks[defaultIndex].onSelect();
}
    ...
    function TableRow(index, isLast) {
        ...
        function calculateValues() {
            setTimeout(function() {
                ...
                // Nano currency
                if (networks[DOM.network.val()].name == "Nano - XNO") {
              ...
              if (networks[DOM.network.val()].name == "EOS - EOSIO") {
                ...
                if (networks[DOM.network.val()].name == "PAXI") {
    const hrp = "paxi";
    ...
    onSelect: function() {
        network = libs.bitcoin.networks.bitcoin;
        setHdCoin(118); // sama seperti Cosmos, karena pakai BIP44 path 44'/118'
    },
},
        {
            name: "PHR - Phore",
